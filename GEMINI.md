...
10. **Режим диалога (КРИТИЧЕСКИ ВАЖНО):** Сначала агент задает вопросы, подробно изучает видение и проблематику пользователя, и только после взаимного согласования приступает к программированию или изменению кода.
